<template>
  <div class="shop-header">
    <nav
      ...
      "
    >
      <a class="back" style="color:#fff ; margin-left:10px" @click="$router.back()">
    ...
    <div class="shop-content">
      <img
        ...
        class="content-image"
      />
      <div class="header-content" @click="showNotice">
        <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
          </span>
          <span class="content-name">嘉禾一品（温都水城）</span>
          <i class="content-icon icon-fanhuijiantou"></i>
        </h2>
    ...
    <div class="shop-header-discounts">
      <div class="discounts-left">
        <div class="activity activity-green" @click="showDiscount">
          <span class="content-tag">
    ...
    <div class="shop-brief-modal" v-show="isShowNotice">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span
            class="iconfont icon-icon_close"
