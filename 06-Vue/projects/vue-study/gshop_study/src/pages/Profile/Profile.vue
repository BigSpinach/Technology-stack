  ...
  <div>
    <section class="profile">
        ...
        <a href="javascript:" class="profile-link">
          ...
          <div class="user-info" @click="toLogin">
            ...
            <p>
              ...
              <span v-if="!user.name" class="icon-mobile-number">{{
      ...
      <section class="profile_my_order border-1px">
        ...
        <a href="javascript:" class="my_order">
          <span>
            <i class="iconfont icon-huiyuan_huaban1"></i>
          </span>
          <div class="my_order_div">
            <span>TiKi外卖会员卡</span>
            <span class="my_order_icon">
      ...
      <section class="profile_my_order border-1px">
        <mt-button @click="logout" type="danger" style="width: 100%"
          >退出登录</mt-button
        >
      </section>
...
export default {
  methods: {
    ...
    logout() {
      ...
      MessageBox.confirm("确定退出登录?").then((actionAgree) => {
        this.$store.commit(LOGOUT);
      },actionReject=>{
        console.log('取消退出登陆');
      });
